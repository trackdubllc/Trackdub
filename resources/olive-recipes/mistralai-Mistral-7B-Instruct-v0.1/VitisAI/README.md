...
|:--------------------------------------------------|:----------------------------------|
| `mistralai/Mistral-7B-Instruct-v0.1`              | `Mistral-7B-Instruct-v0.1_quark_vitisai_llm.json`  |
...
```bash
cd olive-recipes/mistralai-Mistral-7B-Instruct-v0.1/VitisAI
...
✅ Optimized model saved in: `models/Mistral-7B-Instruct-v0.1-vai/`
