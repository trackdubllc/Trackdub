...
|:--------------------------------------------------|:----------------------------------|
| `codellama/CodeLlama-7b-Instruct-hf`                | `CodeLlama-7b-Instruct-hf_quark_vitisai_llm.json`  |
...
```bash
cd olive-recipes/codellama-CodeLlama-7b-Instruct-hf/VitisAI
...
olive run --config CodeLlama-7b-Instruct-hf_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/CodeLlama-7b-Instruct-hf-vai/`
