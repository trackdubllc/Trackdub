...
Usage:
    ...
    python inference.py --benchmark D:/test-images --pytorch_model Qwen/Qwen3.5-35B-A3B
...
def main():
    parser = argparse.ArgumentParser(
        description="ONNX Runtime GenAI inference for Qwen3.5-35B-A3B MoE VLM"
    )
    parser.add_argument(
        "--model_path", type=str, default="cpu_and_mobile/models",
    ...
    parser.add_argument(
        ...
        help="HuggingFace model ID for PyTorch comparison (e.g. Qwen/Qwen3.5-35B-A3B)",
    )
