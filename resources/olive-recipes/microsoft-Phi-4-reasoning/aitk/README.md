...
This folder contains a sample use case of Olive to optimize a Phi-4-reasoning model using OpenVINO tools.

- Intel® NPU: [Phi 4 Reasoning Dynamic Shape Model](https://huggingface.co/microsoft/Phi-4-reasoning)
...
### Phi 4 Reasoning Dynamic Shape Model
...
```bash
python model-chat.py -e follow_config -v -g -m models/Phi-4-reasoning/model/
```
