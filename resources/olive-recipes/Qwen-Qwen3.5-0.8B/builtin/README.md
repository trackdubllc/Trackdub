# Qwen3.5-0.8B ONNX Runtime GenAI Example

This example demonstrates how to convert [Qwen3.5-0.8B](https://huggingface.co/Qwen/Qwen3.5-0.8B) vision-language model to ONNX format using Olive and run inference with ONNX Runtime GenAI.
...
# Larger evaluation
python eval.py --num_samples 500 --pytorch_model Qwen/Qwen3.5-0.8B
