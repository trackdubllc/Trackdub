...
|:--------------------------------------------------|:----------------------------------|
| `meta-llama/Llama-3.2-1B`                | `Llama-3.2-1B_quark_vitisai_llm.json`  |
...
```bash
cd olive-recipes/meta-llama-Llama-3.2-1B/VitisAI
...
olive run --config Llama-3.2-1B_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/Meta-Llama-3.2-1B-vai/`
