...
def get_audio_name(audio_file):
    return os.path.splitext(os.path.basename(audio_file))[0]


def infer_audio(app, model_id, audio_file, save_data: bool, audio_name: str | None = None):
    ...
    audio_name = get_audio_name(audio_file) if not audio_name else audio_name
