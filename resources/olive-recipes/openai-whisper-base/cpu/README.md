# openai-whisper-base — CPU optimization

This folder contains Olive recipes for optimizing openai-whisper-base targeting the CPU EP.

## What this folder is for

- Execution Provider: CPU EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-base_cpu_int8.json
...
3) Run Olive to build/optimize the model
   - olive run --config whisper-base_cpu_int8.json
...
This README was auto-generated for the CPU EP of openai-whisper-base.
