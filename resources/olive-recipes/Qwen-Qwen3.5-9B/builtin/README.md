# Qwen3.5-9B ONNX Runtime GenAI Example

This example demonstrates how to convert [Qwen3.5-9B](https://huggingface.co/Qwen/Qwen3.5-9B) vision-language model to ONNX format using Olive and run inference with ONNX Runtime GenAI.
...
python eval.py --pytorch_model Qwen/Qwen3.5-9B

# Larger evaluation
python eval.py --num_samples 500 --pytorch_model Qwen/Qwen3.5-9B
