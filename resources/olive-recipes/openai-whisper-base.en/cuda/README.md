# openai-whisper-base.en — CUDA optimization

This folder contains Olive recipes for optimizing openai-whisper-base.en targeting the CUDA EP.

## What this folder is for

- Execution Provider: CUDA EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-base.en_cuda_int8.json
...
This README was auto-generated for the CUDA EP of openai-whisper-base.en.
