# openai-whisper-base.en — WebGPU optimization

This folder contains Olive recipes for optimizing openai-whisper-base.en targeting the WebGPU EP.

## What this folder is for

- Execution Provider: WebGPU EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-base.en_webgpu_int8.json
...
3) Run Olive to build/optimize the model
   - olive run --config whisper-base.en_webgpu_int8.json
...
This README was auto-generated for the WebGPU EP of openai-whisper-base.en.
