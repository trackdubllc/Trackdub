...
This folder contains a sample use case of Olive to optimize a Phi-4-reasoning-plus model using OpenVINO tools.

- Intel® NPU: [Phi 4 Reasoning Plus Dynamic Shape Model](https://huggingface.co/microsoft/Phi-4-reasoning-plus)
...
### Phi 4 Reasoning Plus Dynamic Shape Model
...
```bash
python model-chat.py -e follow_config -v -g -m models/Phi-4-reasoning-plus/model/
```
