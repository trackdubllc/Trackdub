...
| :--------------------------------- | :------------------------------ |
| `Qwen/Qwen2.5-3B`       | `Qwen2.5-3B_quark_vitisai_llm.json` |
...
```bash
cd olive-recipes/Qwen-Qwen2.5-3B/VitisAI
...
```bash
# Qwen2.5-3B-Instruct
olive run --config Qwen2.5-3B_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/Qwen2.5-3B-vai/`
