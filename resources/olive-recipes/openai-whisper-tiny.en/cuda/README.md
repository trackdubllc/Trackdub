# openai-whisper-tiny.en — CUDA optimization

This folder contains Olive recipes for optimizing openai-whisper-tiny.en targeting the CUDA EP.

## What this folder is for

- Execution Provider: CUDA EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-tiny.en_cuda_int8.json
...
3) Run Olive to build/optimize the model
   - olive run --config whisper-tiny.en_cuda_int8.json
...
This README was auto-generated for the CUDA EP of openai-whisper-tiny.en.
