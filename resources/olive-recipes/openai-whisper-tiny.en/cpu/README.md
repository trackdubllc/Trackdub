# openai-whisper-tiny.en — CPU optimization

This folder contains Olive recipes for optimizing openai-whisper-tiny.en targeting the CPU EP.

## What this folder is for

- Execution Provider: CPU EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-tiny.en_cpu_int8.json
...
This README was auto-generated for the CPU EP of openai-whisper-tiny.en.
