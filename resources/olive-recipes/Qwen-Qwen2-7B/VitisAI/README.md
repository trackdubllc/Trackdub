...
| :--------------------------------- | :------------------------------ |
| `Qwen/Qwen2-7B`       | `Qwen2-7B_quark_vitisai_llm.json` |
...
```bash
cd olive-recipes/Qwen-Qwen2-7B/VitisAI
...
```bash
# Qwen2-7B
olive run --config Qwen2-7B_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/Qwen2-7B-vai/`
