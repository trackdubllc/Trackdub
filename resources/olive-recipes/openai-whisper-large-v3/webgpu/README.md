# openai-whisper-large-v3 — WebGPU optimization

This folder contains Olive recipes for optimizing openai-whisper-large-v3 targeting the WebGPU EP.

## What this folder is for

- Execution Provider: WebGPU EP
- Typical precision: INT8 precision by default
- Example recipe filename: whisper-large-v3_webgpu_int8.json
...
3) Run Olive to build/optimize the model
   - olive run --config whisper-large-v3_webgpu_int8.json
...
This README was auto-generated for the WebGPU EP of openai-whisper-large-v3.
