# Qwen3-VL-8B-Instruct ONNX Runtime GenAI Example
...
python eval.py --num_samples 100 --pytorch_model Qwen/Qwen3-VL-8B-Instruct
...
|-------|----------|-------------|
| PyTorch FP32 (baseline) | 90.00% | 16.52 s/sample |
| **ONNX INT4 (CPU)** | **85.00%** | **11.85 s/sample** |
| Random chance | 25.00% | — |
