...
|:--------------------------------------------------|:----------------------------------|
| `mistralai/Mistral-7B-v0.3`              | `Mistral-7B-v0.3_quark_vitisai_llm.json`  |
...
```bash
cd olive-recipes/mistralai-Mistral-7B-v0.3/VitisAI
...
olive run --config Mistral-7B-v0.3_quark_vitisai_llm.json
```

✅ Optimized model saved in: `models/Mistral-7B-v0.3-vai/`
