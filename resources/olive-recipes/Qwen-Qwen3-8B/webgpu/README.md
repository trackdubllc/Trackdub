# Qwen-Qwen3-8B — WebGPU optimization

This folder contains Olive recipes for optimizing Qwen-Qwen3-8B targeting the WebGPU EP.

## What this folder is for

- Execution Provider: WebGPU EP
- Typical precision: INT4 precision by default
- Example recipe filename: Qwen-Qwen3-8B_webgpu_int4.json
...
3) Run Olive to build/optimize the model
   - olive run --config Qwen-Qwen3-8B_webgpu_int4.json
...
This README was auto-generated for the WebGPU EP of Qwen-Qwen3-8B.
