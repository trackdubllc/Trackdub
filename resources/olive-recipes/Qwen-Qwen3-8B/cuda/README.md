# Qwen-Qwen3-8B — CUDA optimization

This folder contains Olive recipes for optimizing Qwen-Qwen3-8B targeting the CUDA EP.

## What this folder is for

- Execution Provider: CUDA EP
- Typical precision: INT4 precision by default
- Example recipe filename: Qwen-Qwen3-8B_cuda_int4.json
...
3) Run Olive to build/optimize the model
   - olive run --config Qwen-Qwen3-8B_cuda_int4.json
...
This README was auto-generated for the CUDA EP of Qwen-Qwen3-8B.
