...
function Invoke-RalphLoop {
    ...
    if (-not $currentBranch) {
        throw "Unable to detect current git branch. Ensure you are on a branch (not detached HEAD)."
    }
